...
contract DeployReserve is Script {
    ...
    function run() external {
        ...
        address token
            = vm.envAddress("DEPLOYMENT_RESERVE_TOKEN");
        address tokenOracle
            = vm.envAddress("DEPLOYMENT_RESERVE_TOKEN_ORACLE");
        address vestingVault
            = vm.envAddress("DEPLOYMENT_RESERVE_VESTING_VAULT");
        uint minBacking
            = vm.envUint("DEPLOYMENT_RESERVE_MIN_BACKING");
